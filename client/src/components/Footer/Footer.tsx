      ...
      <div className="footer__container">
        ...
        <div className="footer__column column">
          ...
          <address className="column__contacts contacts">
            ...
            <div className="contacts__contact fa fa-envelope"> daniilbatiuk480@gmail.com</div>
            <div className="contacts__contact fa fa-phone"> +38-(068)-905-06-93</div>
            <div className="contacts__links">
              <a href="https://github.com/DaniilBatiuk">
              ...
              <a href="https://www.linkedin.com/in/daniil-batiuk-59a923271/">
                <svg
              ...
              <a href="https://www.instagram.com/danil_batyuk/">
                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24">
                  <g
                    fill="none"
                    stroke="currentColor"
